...
import com.arashrahimi46.iptv.mobile.data.model.Category
 ...
 * [com.arashrahimi46.iptv.mobile.data.repository.PlaylistRepository.ensureSeriesEpisodesLoaded].
 * [Favorite] is populated starting Phase 4 via [favoriteDao] -- see
 * [com.arashrahimi46.iptv.mobile.data.repository.FavoritesRepository]. [ContinueWatchingEntry] is
 * populated starting P1.2 via [continueWatchingDao] -- see
 * [com.arashrahimi46.iptv.mobile.data.repository.ContinueWatchingRepository]. Adding its DAO is not a
 ...
 * [com.arashrahimi46.iptv.mobile.data.settings.CredentialsStore]).
 *
...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
         ...
         * (see [com.arashrahimi46.iptv.mobile.data.model.Channel]/[com.arashrahimi46.iptv.mobile.data.model.VodTitle]).
         ...
         * [com.arashrahimi46.iptv.mobile.data.model.EPGProgram] for why the table was the app's worst query.
         *
        ...
        /** v14 -> v15: `channels.isRadio`, the provider-declared audio-only flag. Defaults to 0, so
         * existing rows keep the pre-flag behaviour until the next catalog refresh re-parses them. */
        ...
        fun get(context: Context): AppDatabase =
            instance ?: synchronized(this) {
                instance ?: Room.databaseBuilder(
                    ...
                    "are_iptv_mobile.db",
                ).addMigrations(migration1To2(context.applicationContext), MIGRATION_2_3, MIGRATION_3_4, MIGRATION_4_5, MIGRATION_5_6, MIGRATION_6_7, MIGRATION_7_8, MIGRATION_8_9, MIGRATION_9_10, MIGRATION_10_11, MIGRATION_11_12, MIGRATION_12_13, MIGRATION_13_14, MIGRATION_14_15)
