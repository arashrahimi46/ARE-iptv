...
import com.arashrahimi46.iptv.mobile.data.db.CategoryCount
...
import com.arashrahimi46.iptv.mobile.data.parser.StalkerClient
import com.arashrahimi46.iptv.mobile.data.parser.XtreamClient
import com.arashrahimi46.iptv.mobile.data.parser.parseSeriesEpisode
import com.arashrahimi46.iptv.mobile.data.parser.XtreamException
...
class PlaylistRepositoryImpl(context: Context) : PlaylistRepository {
    ...
    private fun buildStalkerChannels(
        sourceId: Long,
        channels: List<com.arashrahimi46.iptv.mobile.data.parser.StalkerChannel>,
        categories: List<com.arashrahimi46.iptv.mobile.data.parser.StalkerCategory>,
    ): List<Channel> {
    ...
    private fun buildStalkerMovies(
        sourceId: Long,
        vod: List<com.arashrahimi46.iptv.mobile.data.parser.StalkerVod>,
        categories: List<com.arashrahimi46.iptv.mobile.data.parser.StalkerCategory>,
    ): List<VodTitle> {
        val catNames = categories.associate { it.id to it.title }
        return vod.map {
    ...
    private fun buildStalkerSeries(
        sourceId: Long,
        series: List<com.arashrahimi46.iptv.mobile.data.parser.StalkerSeries>,
        categories: List<com.arashrahimi46.iptv.mobile.data.parser.StalkerCategory>,
    ): List<VodTitle> {
        val catNames = categories.associate { it.id to it.title }
        return series.map {
