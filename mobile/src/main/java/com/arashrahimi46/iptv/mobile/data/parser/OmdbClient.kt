 ...
 * results are cached permanently on [com.arashrahimi46.iptv.mobile.data.model.VodTitle] and each title is
 * looked up at most once (see [com.arashrahimi46.iptv.mobile.data.repository.PlaylistRepository.ensureMetadataLoaded]).
 */
object OmdbClient {
