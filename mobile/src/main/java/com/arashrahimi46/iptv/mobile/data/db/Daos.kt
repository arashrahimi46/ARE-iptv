 ...
 * survive a refresh. See [com.arashrahimi46.iptv.mobile.data.repository.PlaylistRepository.refreshSource].
 */
...
/**
 * Real favorites persistence (Phase 4) -- see [com.arashrahimi46.iptv.mobile.data.repository.FavoritesRepository]
 ...
 * see [com.arashrahimi46.iptv.mobile.data.repository.ContinueWatchingRepository] for the
 ...
 * [com.arashrahimi46.iptv.mobile.data.repository.RecordingRepository] for the observe/reconcile surface and
 * [com.arashrahimi46.iptv.mobile.data.recording.RecordingSupervisor] for the capture-time writes.
 */
@Dao
