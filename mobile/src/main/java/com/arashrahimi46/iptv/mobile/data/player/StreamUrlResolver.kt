package com.arashrahimi46.iptv.mobile.data.player
...
class DefaultStreamUrlResolver(private val credentials: CredentialsStore) : StreamUrlResolver {
    override suspend fun resolve(
        ...
        val cachedEndpoint = com.arashrahimi46.iptv.mobile.data.parser.StalkerAccountInfo
        ...
        } catch (e: com.arashrahimi46.iptv.mobile.data.parser.StalkerException) {
    ...
    private suspend fun resolveCatchup(
        ...
        return when (source.type) {
            ...
            SourceType.M3U -> {
                ...
                com.arashrahimi46.iptv.mobile.data.parser.expandCatchup(
                    liveUrl = live,
