...
/** The same 15-clause document :tv renders, as a scrolling bottom sheet (§3.3). */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
private fun LegalDocumentSheet(onDismiss: () -> Unit) {
...
private fun legalSections(): List<Pair<Int, Int>> = listOf(
