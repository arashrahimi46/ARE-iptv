package com.arashrahimi46.iptv.mobile.data.model
 ...
 * they live encrypted-at-rest in [com.arashrahimi46.iptv.mobile.data.settings.CredentialsStore],
...
data class PlaylistSource(
     ...
     * [com.arashrahimi46.iptv.mobile.data.parser.XtreamAccountInfo]. */
...
data class VodTitle(
    ...
    // collapse. See [com.arashrahimi46.iptv.mobile.data.repository.PlaylistRepository.ensureMetadataLoaded]. ---
 ...
 * [com.arashrahimi46.iptv.mobile.data.repository.FavoritesRepository].
 */
 ...
 * terminal (see [com.arashrahimi46.iptv.mobile.data.recording.RecordingSupervisor] for the state machine).
